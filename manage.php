   ...
   // require 'dp.php';
    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-light bg-dark p-3">
        ...
        <div class="topnav-right">
            <a class="text-info text-white" href="profile.php" style="text-decoration: none;"><i
        ...
        if ($res) {
            if (mysqli_num_rows($res) > 0) {
                ...
                while ($row = mysqli_fetch_array($res)) {
                    ...
                    echo '<td>';
                    //echo 'Change role to:';
                    echo '<a href="javascript:void(0)" title="Change Status" class="student_btn_ajax btn btn-outline-success ms-3 mt-2" data-toggle="tooltip">Student</a>';
                    echo '<input type="hidden" class="student_id_value" value=' . $row["id"] . '>';
                    echo '<a href="javascript:void(0)" title="Change Status" class="admission_btn_ajax btn btn-outline-success ms-3 mt-2" data-toggle="tooltip">Admission</a>';
                    echo '<input type="hidden" class="teacher_id_value" value=' . $row["id"] . '>';
                    echo '<a href="javascript:void(0)" title="Change Status" class="teacher_btn_ajax btn btn-outline-success ms-3 mt-2" data-toggle="tooltip">Teacher</a>';
